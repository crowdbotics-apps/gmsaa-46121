"""
Django settings for gmsaa_46121 project.
...
WSGI_APPLICATION = 'gmsaa_46121.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gmsaa_46121 API",
    "DESCRIPTION": "API documentation for gmsaa_46121 App",
    "VERSION": "v1",
}
